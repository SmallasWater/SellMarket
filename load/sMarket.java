...
public class sMarket extends PluginBase {
    ...
    public LinkedHashMap<String, pItems> playerItems = new LinkedHashMap<>();

    public LinkedHashMap<Player, Item> handItem = new LinkedHashMap<>();

    public LinkedList<banItem> banItems = new LinkedList<>();

    public LinkedHashMap<Player, iTypes> clickItem = new LinkedHashMap<>();

    public LinkedHashMap<Player, sType> clickPos = new LinkedHashMap<>();

    public LinkedHashMap<Player,LinkedList<iTypes>> seekItem = new LinkedHashMap<>();

    public LinkedHashMap<Player, seekSetting> seekSetting = new LinkedHashMap<>();
    ...
    public File getPlayerFile(String playerName){
        return new File(sMarket.getApi().getDataFolder()+"/Players/"+playerName+".yml");
    }
