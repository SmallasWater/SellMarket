            ...
            switch (fromId){
                case create.MENU:
                    ...
                    case create.CHOSE:
                        ...
                        sMarket.getApi().clickItem.put(player,types.get(Integer.parseInt(data)));
                    ...
                    case create.SEEK:
                        ...
                        sMarket.getApi().seekSetting.put(player,new seekSetting(seek,setting,sqrt));
                    ...
                    case create.TYPES:
                        ...
                        sMarket.getApi().clickPos.put(player,Tools.getTypeByInt(Integer.parseInt(data)));
                    ...
                    case create.SEEK_MENU:
                        ...
                        iTypes item = sMarket.getApi().seekItem.get(player).get(Integer.parseInt(data));
                        sMarket.getApi().clickItem.put(player,item);
                    ...
                    case create.SETTING:
                        ...
                        iTypes it = sMarket.getApi().clickItem.get(player);
                    ...
                    case create.BUY_MENU:
                        ...
                        datas = Tools.decodeData(data);
                        iTypes its = sMarket.getApi().clickItem.get(player);
                        its.setCount((int)(double) datas[1]);
                        PlayerBuyItemEvent event1 = new PlayerBuyItemEvent(player,its);
                    ...
                    case create.TYPES_SHOW:
                        ...
                        item = Tools.getItemsByType(sMarket.getApi().clickPos.get(player)).get(Integer.parseInt(data));
                        sMarket.getApi().clickItem.put(player,item);
                        if(item.getMaster().equals(player.getName())){
                            create.sendSetting(player);
                        }else{
                    ...
                    case create.UPDATA:
                        ...
                        Item click = sMarket.getApi().handItem.get(player);
